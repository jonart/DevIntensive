...
public class UserDao extends AbstractDao<User, Long> {
    ...
    public static class Properties {
        ...
        public final static Property FullNmae = new Property(3, String.class, "fullNmae", false, "FULL_NMAE");
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"USERS\" (" + //
                ...
                "\"PHOTO\" TEXT," + // 2: photo
                "\"FULL_NMAE\" TEXT NOT NULL UNIQUE ," + // 3: fullNmae
    ...
    protected final void bindValues(DatabaseStatement stmt, User entity) {
        ...
        stmt.bindString(4, entity.getFullNmae());
    ...
    public User readEntity(Cursor cursor, int offset) {
        User entity = new User( //
            ...
            cursor.getString(offset + 3), // fullNmae
    ...
    public void readEntity(Cursor cursor, User entity, int offset) {
        ...
        entity.setFullNmae(cursor.getString(offset + 3));

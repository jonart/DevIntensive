...
public class UsersAdapter extends RecyclerView.Adapter<UsersAdapter.UserViewHolder>{
    ...
    public void onBindViewHolder(final UsersAdapter.UserViewHolder holder, int position) {
        ...
        if(user.getPhoto().isEmpty()){
            userPhoto = "null";
            Log.e(TAG, "onBindViewHolder: user with name " + user.getFullNmae() + " has empty photo");
        }
        else {
        ...
        holder.mFullName.setText(user.getFullNmae());
    ...
    public static class UserViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        public UserViewHolder(View itemView, CustomClickListener customClickListener) {
            ...
            mRating = (TextView) itemView.findViewById(R.id.raiting_txt);
            ...
            mDummy = userPhoto.getContext().getResources().getDrawable(R.drawable.bg2);
